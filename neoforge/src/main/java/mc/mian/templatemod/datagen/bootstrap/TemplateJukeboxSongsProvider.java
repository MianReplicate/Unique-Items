...
public class TemplateJukeboxSongsProvider {
    private static void register(
        ...
        context.register(
                key, new JukeboxSong(Holder.direct(soundEvent.get()), Component.translatable(Util.makeDescriptionId("jukebox_song", key.identifier())), (float)lengthInSeconds, comparatorOutput)
        );
    }
