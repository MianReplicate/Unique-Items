...
public class TemplateConstants {
    ...
    public static final Identifier TEMPLATE_SOUND = TemplateUtil.modLoc("scratch");
    public static final Identifier TEMPLATE_SOUND_2 = TemplateUtil.modLoc("meow");
    public static final Identifier TEMPLATE_SOUND_3 = TemplateUtil.modLoc("fail");
}
